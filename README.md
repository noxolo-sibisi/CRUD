...
A production-ready RESTful API built with Spring Boot, featuring secure MySQL integration, automated data management with JPA/Hibernate, and interactive OpenAPI documentation.
...
* [Swagger OpenAPI Specification 3.0.3](http://localhost:8081/swagger-ui/index.html)
